...
const validator = v.object({
  ...
  logging: v.optional(
    v.object({
      level: v.optional(v.enum(LogLevel), LogLevel.INFO),
      enableConsole: v.optional(v.boolean(), true),
      enableFile: v.optional(v.boolean(), true),
      logDir: v.optional(v.string(), "logs"),
    }),
  ),
});
